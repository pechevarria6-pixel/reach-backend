...
- Array []
+ Array [
+   "Origin https://www.alcanzar.io is not allowed by Access-Control-Allow-Origin. Status code: 429",
+   "Failed to load resource: Origin https://www.alcanzar.io is not allowed by Access-Control-Allow-Origin. Status code: 429",
+ ]
```

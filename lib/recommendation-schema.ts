...
About $${v.budget || 100} a head, ${v.travelers || 4} people, near ${v.location || 'the city'}.
...
${v.travelers || 4} people, near ${v.location || 'the city'}.
...
leaving from ${v.location || 'home'}. Avoid: ${(v.dealbreakers as string[] || []).join(', ') || 'nothing'}.
...
About $${v.budget || 2000} each, ${v.travelers || 4} travelling, from ${v.location || 'home'}.
